...
*
*********************************************************************/ 
 public class Objects_Strategies_Page {
     ...
     public static class Strategies{
	     ...
	     public static String txt_Strategies_Search(WebDriver driver){
	 	   	 
	    	 String sCheckedValue = Strategies.txt_Search_Input(driver).getAttribute("value");
