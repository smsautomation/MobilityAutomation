...
* Date: 14/06/2016
* Function: Procedures_Page
* Purpose: This class contains all of the elements on the Procedures page
* Arguments: 
* 			
* Returns: 
**********************************************************************
...
*
*********************************************************************/ 
 public class Objects_Procedures_Page {
 
    private static WebElement element = null;
    private static String sRepositoryName = "Objects_Procedures_Page";
    ...
    public static class Procedures{
    	...
    	public static WebElement lbl_Search_Results(WebDriver driver){
     	...
     	public static String txt_Procedures_Search(WebDriver driver){
	    	 
     		String sCheckedValue = Procedures.txt_Search_Input(driver).getAttribute("value");
