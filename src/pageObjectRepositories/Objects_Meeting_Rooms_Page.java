...
* Date: 14/06/2016
* Function: Objects_Meeting_Rooms_Page
* Purpose: This class contains all of the elements on the Meeting Rooms page
* Arguments: 
* 			
* Returns: 
**********************************************************************
...
*
*********************************************************************/ 
 public class Objects_Meeting_Rooms_Page {
 
    private static WebElement element = null;
    private static String sRepositoryName = "Objects_Meeting_Rooms_Page";
    ...
    public static class Meeting_Rooms{
    	...
    	public static WebElement lbl_Search_Results(WebDriver driver){
     	...
     	public static String txt_Meeting_Rooms_Search(WebDriver driver){
	    	 
     		String sCheckedValue = Meeting_Rooms.txt_Search_Input(driver).getAttribute("value");
