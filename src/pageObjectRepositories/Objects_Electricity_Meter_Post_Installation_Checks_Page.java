...
public class Objects_Electricity_Meter_Post_Installation_Checks_Page {
    ...
    public static WebElement btn_Polarity_Check_Meter_Yes(WebDriver driver){
		...
		try{
			element = driver.findElement(By.xpath(".//*[@id='app']/div/div/div[2]/div[2]/ng-switch/div/electask/div/div/posttest/div/div[3]/div[2]/div/label/span/span"));
 		}catch(Exception e){
    ...
    public static WebElement btn_Socket_Safety_Test_Pass(WebDriver driver){
		...
		try{
			element = driver.findElement(By.xpath(".//*[@id='app']/div/div/div[2]/div[2]/ng-switch/div/electask/div/div/posttest/div/div[7]/div[2]/div/label/span/span"));
 		}catch(Exception e){
