...
* Date: 10/06/2016
* Function: Objects_Guidance_Item_Page
...
*
*********************************************************************/ 
 public class Objects_Guidance_Item_Page {
 
    private static WebElement element = null;
    private static String sRepositoryName = "Objects_Guidance_Item_Page";
    ...
    public static class Guidance_Item{
    	...
    	public static WebElement lbl_Owner(WebDriver driver){
    		...
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div/div[3]/span[1]/nobr/span/a"));
    		}catch(Exception e){
    	...
    	public static WebElement lbl_Summary_Abstract_Header(WebDriver driver){
	    	 
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/h3"));
    		}catch(Exception e){
	    		Log.error(sRepositoryName + " | lbl_Summary_Abstract_Header not found | Exception desc : "+e.getMessage());		
			}
    	    return element;
    	}
    	...
    	public static WebElement lnk_User_Name(WebDriver driver){
    		...
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[4]/div[2]/div[2]/div/div[1]/div/span/div[1]/div[5]/div[1]/div/table/tbody/tr[1]/td[3]/span[1]/a"));
    		}catch(Exception e){
    	...
    	public static WebElement lbl_Comment_Date(WebDriver driver){
    		...
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[4]/div[2]/div[2]/div/div[1]/div/span/div[1]/div[5]/div[1]/div/table/tbody/tr[1]/td[3]/span[2]"));
    		}catch(Exception e){
    	...
    	public static WebElement lbl_User_Comment(WebDriver driver){
    		...
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[4]/div[2]/div[2]/div/div[1]/div/span/div[1]/div[5]/div[1]/div/table/tbody/tr[2]/td/div/p"));
    		}catch(Exception e){
	    		Log.error(sRepositoryName + " | txt_User_Comment not found | Exception desc : "+e.getMessage());		
			}
    	    return element;
    	}
    	
    //END OF GUIDANCE ITEM METHODS    	
    }
