...
* Date: 09/06/2016
* Function: Objects_News_Item_Page
* Purpose: This class contains all of the elements on the News Item page
* Arguments: 
* 			
* Returns: 
**********************************************************************
...
*
*********************************************************************/ 
 public class Objects_News_Item_Page {
 
    private static WebElement element = null;
    private static String sRepositoryName = "Objects_News_Item_Page";
    ...
    public static class News_Item{
    	...
    	public static WebElement lbl_Owner(WebDriver driver){
    		...
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div/div[3]/span[2]"));
    		}catch(Exception e){
    	...
    	public static WebElement txt_Comments_Input(WebDriver driver){
    		...
    		try{
    			element = driver.findElement(By.xpath("/html/body/form/div[4]/div/div/div[1]/div[2]/div[2]/div[2]/div[4]/div[2]/div[2]/div/div[1]/div/span/div[1]/div[1]/table/tbody/tr[1]/td/div/p"));
    		}catch(Exception e){
