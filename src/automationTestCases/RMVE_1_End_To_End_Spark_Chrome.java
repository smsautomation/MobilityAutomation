...
public class RMVE_1_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_24_RMVE1')]")).click();
		...
		Log.info("Test 24 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>RMVE_1_End_To_End_Spark_Chrome");
