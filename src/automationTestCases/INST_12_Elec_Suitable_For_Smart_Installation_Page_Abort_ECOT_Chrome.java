/* *******************************************************************
* Test Case Name: INST_12_Elec_Suitable_For_Smart_Installation_Page_Abort_ECOT_Chrome
...
public class INST_12_Elec_Suitable_For_Smart_Installation_Page_Abort_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_213_INST12')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 222);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 222);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 222);
		...
		Log.info("Test 213 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_12_Elec_Suitable_For_Smart_Installation_Page_Abort_ECOT_Chrome");
