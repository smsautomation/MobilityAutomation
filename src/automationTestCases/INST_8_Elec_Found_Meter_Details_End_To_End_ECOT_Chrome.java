/* *******************************************************************
* Test Case Name: INST_8_Elec_Found_Meter_Details_End_To_End_ECOT_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
import webModule.Methods_Electricity_Meter_Meter_Credit;
...
public class INST_8_Elec_Found_Meter_Details_End_To_End_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_225_INST8')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 114);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 114);
			
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 114);
		...
		Log.info("Test 225 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_8_Elec_Found_Meter_Details_End_To_End_ECOT_Chrome");
