/* *******************************************************************
* Test Case Name: Tasks_And_Tools_Add_New_Task_Valid_Data_Firefox_Content_Author
* Author: Rory Cruickshank
* Date: 23/06/2016
* Purpose: This test attempts to create a new Tasks and Tools task using valid input for a Content Author
* 			in Firefox
*
**********************************************************************
* Change Log:
...
public class Tasks_And_Tools_Add_New_Task_Valid_Data_Firefox_Content_Author {
	...
	public void main() throws Exception {
		...
		Objects_Navigation_Bar.Settings.lnk_Site_Contents_Content_Author(driver).click();
