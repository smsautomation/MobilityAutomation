/* *******************************************************************
* Test Case Name: Exchange_3_Suitable_For_Smart_Installation_Abort_Chrome
* Author: Iain Storrie
* Date: 20/06/2017
...
public class Exchange_3_Gas_SMeter_Post_Installation_Pressure_Drop_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[27]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_133_EXCH3')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 133);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 133);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 133);
	...
	*/
		...
		Methods_Gas_Meter_Post_Installation_Gas_Tightness_Test.addAbortPressureDropValues(driver, sTestCaseName);
