...
public class Policies_Page_Delete_Other_Comment_Firefox_Visitor {
	...
	public void main() throws Exception {
		...
		//Log out so we can log back in as a Visitor
		driver.quit();
		
		//Now log in as a Visitor
