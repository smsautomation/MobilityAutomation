/* *******************************************************************
* Test Case Name: INST_12_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_ECOT_Chrome
...
public class INST_12_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 219);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 219);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 219);
		...
		Log.info("Test 210 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_12_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_ECOT_Chrome");
