/* *******************************************************************
* Test Case Name: INST_8_Elec_Risk_Assessment_Page_Abort_ECOT_Chrome
...
public class INST_8_Elec_Risk_Assessment_Page_Abort_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_224_INST8')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 113);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 113);
			
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 113);
		...
		Log.info("Test 224 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_8_Elec_Risk_Assessment_Page_Abort_ECOT_Chrome");
