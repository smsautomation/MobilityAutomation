/* *******************************************************************
* Test Case Name: Add_An_App_Check_Links_Firefox_Administrator
* Author: Rory Cruickshank
* Date: 23/06/2016
* Purpose: This test views all of the elements on the main Add An App page for an Administrator 
* 			in Firefox
*
**********************************************************************
* Change Log:
...
public class Add_An_App_Check_Links_Firefox_Administrator {
	...
	public void main() throws Exception {
		...
		Objects_Navigation_Bar.Settings.lnk_Add_An_App(driver).click();
