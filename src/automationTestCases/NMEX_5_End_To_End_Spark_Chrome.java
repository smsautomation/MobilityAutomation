...
public class NMEX_5_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_40_NMEX5')]")).click();
		...
		Log.info("Test 40 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>NMEX_5_End_To_End_Spark_Chrome");
