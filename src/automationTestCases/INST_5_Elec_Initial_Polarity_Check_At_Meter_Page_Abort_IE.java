/* *******************************************************************
* Test Case Name: INST_5_Elec_Initial Polarity_Check_At_Meter_Abort_IE
* Author: Iain Storrie
* Date: 04/07/2017
...
* on the IE browser for an Install 5 job
*
**********************************************************************
* Change Log:
* 
...
public class INST_5_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_IE {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[158]/div/div[1]/div/div[1]/span[1]/span")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 100);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 100);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 100);
