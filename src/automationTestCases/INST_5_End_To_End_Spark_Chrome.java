...
public class INST_5_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_106_INST5')]")).click();
		...
		Log.info("Test 106 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_5_End_To_End_Spark_Chrome");
