/* *******************************************************************
* Test Case Name: INST_12_Elec_Risk_Assessment_Page_Abort_ECOT_Chrome
...
public class INST_12_Elec_Risk_Assessment_Page_Abort_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_212_INST12')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 221);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 221);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 221);
		...
		Log.info("Test 212 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_12_Elec_Risk_Assessment_Page_Abort_ECOT_Chrome");
