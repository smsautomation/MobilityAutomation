/* *******************************************************************
* Test Case Name: Guidance_Page_View_Page_Firefox_Administrator
* Author: Rory Cruickshank
* Date: 23/06/2016
* Purpose: This test views all of the elements on the main Guidance page for an Administrator in Firefox
*
**********************************************************************
* Change Log:
* 
...
public class Guidance_Page_View_Page_Firefox_Administrator {
	...
	public void main() throws Exception {
		...
		Methods_Guidance.viewPage(driver, sTestCaseName);
		
		//Call the method to check the Policies sidebar
		Methods_Guidance.viewSidebar(driver, sTestCaseName);		
