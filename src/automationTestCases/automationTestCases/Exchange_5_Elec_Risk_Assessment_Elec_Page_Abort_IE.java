/* *******************************************************************
* Test Case Name: Exchange_5_Elec_Risk_Assessment_Elec_Abort_IE
* Author: Iain Storrie
* Date: 05/07/2017
...
* IE browser for an Exchange 5 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_5_Elec_Risk_Assessment_Elec_Page_Abort_IE {
...
Methods_Login.viewPage(driver, sTestCaseName);
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 80);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 80);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 80);
