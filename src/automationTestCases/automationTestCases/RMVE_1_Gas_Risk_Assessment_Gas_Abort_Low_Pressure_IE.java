/* *******************************************************************
* Test Case Name: RMVE_1_Gas_Risk_Assessment_Gas_Abort_Low_Pressure_IE
* Author: Iain Storrie
* Date: 10/07/2017
...
public class RMVE_1_Gas_Risk_Assessment_Gas_Abort_Low_Pressure_IE {
	...
	public void main() throws Exception {
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 28);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 28);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 28);
