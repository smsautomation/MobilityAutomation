...
public class RMVE_1_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_29_RMVE1')]")).click();
		...
		Log.info("Test 29 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>RMVE_1_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_Chrome");
