...
* Date: 23/06/2016
* Purpose: This test attempts to create a Breaking News item using valid input for an Administrator in IE
*
**********************************************************************
* Change Log:
* 
...
public class Breaking_News_Add_New_Item_Valid_Details_IE_Administrator {
