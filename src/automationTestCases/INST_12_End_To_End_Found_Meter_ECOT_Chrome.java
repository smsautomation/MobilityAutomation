/* *******************************************************************
* Test Case Name: INST_12_End_To_End_Found_Meter_ECOT_Chrome
* Author: Iain Storrie
* Date: 30/06/2017
...
public class INST_12_End_To_End_Found_Meter_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_215_INST12')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 224);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 224);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 224);
		...
		Log.info("Test 215 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_12_End_To_End_Found_Meter_ECOT_Chrome");
