/* *******************************************************************
* Test Case Name: Breaking_News_Add_New_Item_Invalid_Details_Chrome_Administrator
* Author: Rory Cruickshank
* Date: 23/06/2016
* Purpose: This test attempts to create a Breaking News item using invalid input for an Administrator
* 			in Chrome
*
**********************************************************************
* Change Log:
...
public class Breaking_News_Add_New_Item_Invalid_Details_Chrome_Administrator {
	...
	public void main() throws Exception {
		...
		if(bAddAnAppExists == true){
			...
			Log.error("Add an App link displayed but not expected for Administrator");
		}
