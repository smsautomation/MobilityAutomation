...
public class INST_8_Elec_Initial_Polarity_Fail_Proceed_End_To_End_ECOT_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_221_INST8')]")).click();
		...
		Methods_Electricity_Meter_Initial_Polarity_Check_At_Meter.addSuccessValuesINSTFail(driver, sTestCaseName);
		...
		Log.info("Test 221 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_8_Elec_Initial_Polarity_Fail_Proceed_End_To_End_ECOT_Chrome");
