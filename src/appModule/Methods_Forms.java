...
public class Methods_Forms{
	...
	****************************************************************************************************/	
	public static void viewSidebar(WebDriver driver, String sTestCaseName) throws Exception{
		...
		Utils.checkboxHandler("Filter Results by Location", Objects_Forms_Page.Sidebar.chk_Filter_Results(driver), bFilter);
	
		sNoRefiners = Objects_Forms_Page.Sidebar.lbl_No_Refiners(driver).getText();
	...
	****************************************************************************************************/	
	public static void viewPage(WebDriver driver, String sTestCaseName) throws Exception{
		...
		sHeader = Objects_Forms_Page.Forms.lbl_Search_Results(driver).getText();
		Log.info(sTestCaseName + " | \"" + sHeader + "\" displayed as Header");
		
		if (Objects_Forms_Page.Forms.btn_Search(driver).isDisplayed() == true){
			Log.info(sTestCaseName + " | Search button displayed");		
		}
		
		sNoMatches = Objects_Forms_Page.Forms.lbl_No_Matches(driver).getText();
