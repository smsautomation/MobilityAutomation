...
public class Methods_Procedures{
	...
	****************************************************************************************************/	
	public static void viewSidebar(WebDriver driver, String sTestCaseName) throws Exception{
		...
		Utils.checkboxHandler("Filter Results by Location", Objects_Procedures_Page.Sidebar.chk_Filter_Results(driver), bFilter);
		
		sNoRefiners = Objects_Procedures_Page.Sidebar.lbl_No_Refiners(driver).getText();
	...
	* Date: 14/06/2016
	* Function: viewPage
	* Purpose: This method checks the main page elements on the Procedures page
	* Arguments: 
	* 			
	* Returns: 
	*****************************************************************************************************
	...
	****************************************************************************************************/	
	public static void viewPage(WebDriver driver, String sTestCaseName) throws Exception{
		...
		sHeader = Objects_Procedures_Page.Procedures.lbl_Search_Results(driver).getText();
		Log.info(sTestCaseName + " | \"" + sHeader + "\" displayed as Header");
		
		if (Objects_Procedures_Page.Procedures.btn_Search(driver).isDisplayed() == true){
			Log.info(sTestCaseName + " | Search button displayed");		
		}
		
		sNoMatches = Objects_Procedures_Page.Procedures.lbl_No_Matches(driver).getText();
