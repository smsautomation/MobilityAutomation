...
public class Methods_Electricity_Meter_Additional_Electricity_Tests{
	...
	****************************************************************************************************/	
	public static void addSuccessValues(WebDriver driver, String sTestCaseName) throws Exception{
		...
		Objects_Electricity_Meter_Additional_Electricity_Tests_Page.cbx_Cable_Marker(driver).sendKeys(Keys.TAB);{
		...
		Objects_Electricity_Meter_Additional_Electricity_Tests_Page.cbx_Earth_Type(driver).sendKeys(Keys.TAB);{
